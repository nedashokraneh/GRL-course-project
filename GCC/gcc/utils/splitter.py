...
def random_split(dataset, frac_train=0.8, frac_valid=0.1, frac_test=0.1, seed=0):
    ...
    train_idx = all_idx[:int(frac_train * num_data)]
    valid_idx = all_idx[int(frac_train * num_data):int(frac_valid * num_data)
                                                   + int(frac_train * num_data)]
    test_idx = all_idx[int(frac_valid * num_data) + int(frac_train * num_data):]

    assert len(set(train_idx).intersection(set(valid_idx))) == 0
    assert len(set(valid_idx).intersection(set(test_idx))) == 0
    assert len(train_idx) + len(valid_idx) + len(test_idx) == num_data
